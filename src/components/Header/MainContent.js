...
function MainContent() {
    return ( <div className="relative w-[100%] h-[100vh] text-white">
                ...
                <video src={videoBg} auto="true" loop muted className="absolute z-[-2] top-0 h-[100vh] w-[100vw] object-cover" />
                <div className="pl-10 pt-28">
                    <div className="text-[2.5rem] font-bold mb-[8rem] mt-[6rem] ml-[2rem]">Name of the Movie</div>
                    <div className="ml-[2rem]">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Earum omnis accusantium dolore esse aliquid? Quisquam.</div>
